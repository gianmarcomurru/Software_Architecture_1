...
\begin{itemize}
  ...
  \item 03/03/22 How are we going to accommodate the different integrations and shifting workloads across the services? \\
         \indent\indent 07/03/22 Our architectural main pattern will be micro-services because it allows us to be able to manage individual components and let them scale independently responding better to specific user requests.
  ...
  \item 12/03/22 REST Pull or REST Push for data coming from integrations? 
  \end{todolist}
\end{itemize}
\end{document}
