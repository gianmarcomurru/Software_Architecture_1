...
\begin{titlepage}
    \begin{center}
      ...
      Software Architecture, MSc\\
        ...
        \includegraphics[width=0.4\textwidth]{template/ITU_logo_UK jpg.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{figures/tmp_context.png}
...
\begin{itemize}
    \item The system should give an overview of a citizen's financial status, which includes:
    \begin{itemize}
